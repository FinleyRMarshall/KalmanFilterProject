...
c_figure_txt = [
    ...
    'Figure 12: View the model\'s position estimates when the RC car travels in a straight line. The credible intervals of the position estimates are shown every 200 seconds',
    'Figure 13: View the model\'s position estimates when the RC car travels around a corner. The credible intervals of the position estimates are shown every 50 seconds',
    'Figure 14: View the model\'s position estimates when the RC car travels around the racetrack. The credible intervals of the position estimates are shown every 200 seconds',
